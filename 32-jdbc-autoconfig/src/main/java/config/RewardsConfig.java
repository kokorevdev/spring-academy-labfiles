...
public class RewardsConfig {
    ...
    public AccountRepository accountRepository() {
        JdbcAccountRepository repository = new JdbcAccountRepository(this.dataSource());
        return repository;
    }

    @Bean
    public RestaurantRepository restaurantRepository() {
        JdbcRestaurantRepository repository = new JdbcRestaurantRepository(this.dataSource());
        return repository;
    }

    @Bean
    public RewardRepository rewardRepository() {
        JdbcRewardRepository repository = new JdbcRewardRepository(this.dataSource());
        return repository;
    }
